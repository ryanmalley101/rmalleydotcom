...
export const CLOUD_VENDOR_DEFAULTS: Record<string, VendorDefaultEntry> = {
  ...
  "Avigilon Alta (Motorola Solutions)": {
    ...
    fieldMeta: {
      ...
      cameraCost: { value: 1368, status: "sourced", confidence: "high", sources: ["https://www.lttpartners.com/products/avigilon-alta-h6sl-dome-outdoor-camera-5mp"], reasoning: "Alta H6SL Dome Outdoor 5MP $1,368, confirmed directly — matches the 5MP-outdoor spec used across the on-prem camera table instead of an unsourced street-price guess.", checkedOn: "2026-07-27" },
  ...
  "Spot AI": {
    ...
    fieldMeta: {
      ...
      applianceCost: { value: 2199, status: "sourced", confidence: "high", sources: ["https://www.spot.ai/blog/introducing-spot-ai-enterprise-nvr"], reasoning: "Spot AI Enterprise NVR (current flagship appliance, NVIDIA GPU on-device analytics) starts at $2,199, confirmed directly — replaces the prior single-anecdote figure for an older/smaller \"Vision Edge\" unit.", checkedOn: "2026-07-27" },
